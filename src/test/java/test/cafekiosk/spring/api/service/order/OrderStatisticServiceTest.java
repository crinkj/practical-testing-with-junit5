package test.cafekiosk.spring.api.service.order;
...
import test.cafekiosk.spring.domain.orderproduct.OrderProductRepository;
...
import static test.cafekiosk.spring.domain.product.ProductSellingStatus.SELLING;
...
class OrderStatisticServiceTest extends IntegrationTestSupport {
    ...
    void OrderStatisticServiceTest() {
        // given
